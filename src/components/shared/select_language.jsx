...
function SelectLanguage ({ history }) {
  ...
  return (
    <a
      ...
      className='icon language language--white'
      target='_blank'
    >
      <GlobeIcon isAbout={isWhite} />
